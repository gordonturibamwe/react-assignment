  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className='pb-10 h-[90vh] text-center flex flex-col items-center justify-center'>
        ...
        <div className="mt-0 post text-md text-gray-600 text-center py-6 max-w-[400px]">You need to join to view Group. Join Group to view posts and fellow members.</div>
