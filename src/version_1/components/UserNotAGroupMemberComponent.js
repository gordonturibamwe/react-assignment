  ...
  return (
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
      <div className='pb-10 h-[90vh] text-center flex flex-col items-center justify-center'>
        <h1 className="font-semibold text-center text-4xl mr-4 capitalize text-gray-600">{props.group.name}</h1>
        <div className="mt-0 post text-md text-gray-600 text-center py-6 max-w-[300px]">You need to be a group member to view posts and its members.</div>
